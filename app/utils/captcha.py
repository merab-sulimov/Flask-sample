...
def create_captcha(loc='app/utils/fonts', size=(100, 30), chars=CHARS, amount=6, img_type='GIF', mode='RGB',
                   bg_color=(255, 255, 255), fg_color=(0, 0, 0), font_size=32, font_type='Vera',
    ...
    img = img.resize(map(lambda x: int(x*1.5), size), Image.ANTIALIAS)
